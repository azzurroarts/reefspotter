...
export default function FishPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-blue-500 via-cyan-400 to-white">
      ...
      <div className="page-content relative z-20 p-4">
        <h1 className="sticky-title text-white text-4xl md:text-5xl font-bold lowercase mb-6 z-20">reefspotter</h1>

        {/* Sticky buttons */}
        <div className="sticky-button-container z-20">
        ...
        {/* Progress bar */}
        <div className="progress-container mt-4 relative z-20">
        ...
        {/* Profile Modal */}
        {isProfileOpen && (
          <div className="profile-modal z-30">
        ...
        {/* Species Cards */}
        <div className="species-grid mt-8 relative z-10">
          {filteredSpecies
        ...
        {/* Alphabet Sidebar */}
        <div className="vertical-alphabet z-30">
          {alphabet.map((letter) => (
            <span
              key={letter}
