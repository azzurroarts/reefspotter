        ...
        .map(fish => {
          ...
          return (
            <div
              ...
              className={`cursor-pointer bg-white border rounded p-2 flex flex-col items-center transition-all duration-300 ${isUnlocked ? 'bg-opacity-100' : 'bg-opacity-30'} max-h-80 overflow-hidden`}
            >
              <img
                src={fish.image_url}
                alt={fish.name}
